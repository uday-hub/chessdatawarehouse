...
const Home = () => {
  ...
  return (
    <div>
      <section
        className=" text-light p-5 p-lg-0 py-lg-5 text-center text-sm-start"
          ...
          <div className="d-sm-flex align-items-center justify-content-between my-5">
            <div className="my-5">
              <h1>
                ...
                <span className="text-warning"> Chess</span>
              </h1>
                ...
                return (
                  <>
                    <div className="col-md p-5 text-dark">
                      ...
                      <a href={post.join_request} className="btn btn-dark mt-3">
